...
class Matcher_Parser_82:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_81())
...
class Matcher_Parser_85:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_84().run(stream))
...
class Matcher_Parser_90:
    def run(self, stream):
        return stream.bind('y', Matcher_Parser_89().run(stream))
...
class Matcher_Parser_98:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_97())
class Matcher_Parser_99:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_98().run(stream))
...
class Matcher_Parser_111:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_110().run(stream))
...
class Matcher_Parser_119:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_118().run(stream))
...
class Matcher_Parser_145:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_144().run(stream))
...
class Matcher_Parser_152:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_151())
...
class Matcher_Parser_155:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_154())
...
class Matcher_Parser_158:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_157().run(stream))
...
class Matcher_Parser_162:
    def run(self, stream):
        return stream.bind('y', Matcher_Parser_161().run(stream))
...
class Matcher_Parser_165:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_164())
...
class Matcher_Parser_176:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_175())
class Matcher_Parser_177:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_176().run(stream))
...
class Matcher_Parser_188:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_187())
...
class Matcher_Parser_204:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_203())
class Matcher_Parser_205:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_204().run(stream))
...
class Matcher_Parser_214:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_213().run(stream))
...
class Matcher_Parser_217:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_216())
...
class Matcher_Parser_220:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_219().run(stream))
...
class Matcher_Parser_233:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_232().run(stream))
...
class Matcher_Parser_244:
    def run(self, stream):
        return stream.bind('y', Matcher_Parser_243().run(stream))
class Matcher_Parser_245:
    def run(self, stream):
        return rules['Parser.actionExpr'].run(stream)
class Matcher_Parser_246:
    def run(self, stream):
        return stream.bind('z', Matcher_Parser_245().run(stream))
...
class Matcher_Parser_280:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_279())
class Matcher_Parser_281:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_280().run(stream))
...
class Matcher_Parser_289:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_288().run(stream))
...
class Matcher_Parser_294:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_293())
class Matcher_Parser_295:
    def run(self, stream):
        return stream.bind('ys', Matcher_Parser_294().run(stream))
...
class Matcher_Parser_309:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_308())
class Matcher_Parser_310:
    def run(self, stream):
        return stream.bind('ys', Matcher_Parser_309().run(stream))
class Matcher_Parser_311:
    def run(self, stream):
        return rules['Parser.hostExpr'].run(stream)
class Matcher_Parser_312:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_311().run(stream))
...
class Matcher_Parser_318:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_317().run(stream))
...
class Matcher_Parser_325:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_324())
...
class Matcher_Parser_334:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_333())
...
class Matcher_Parser_337:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_336())
...
class Matcher_Parser_339:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_338())
class Matcher_Parser_340:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_339().run(stream))
...
class Matcher_Parser_351:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_350())
...
class Matcher_Parser_358:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_357())
...
class Matcher_Parser_383:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_382())
...
class Matcher_Parser_394:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_393())
class Matcher_Parser_395:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_394().run(stream))
...
rules['Parser.sequence'] = Matcher_Parser_83()
rules['Parser.expr'] = Matcher_Parser_109()
rules['Parser.expr1'] = Matcher_Parser_143()
rules['Parser.expr2'] = Matcher_Parser_212()
rules['Parser.matchChar'] = Matcher_Parser_218()
rules['Parser.maybeAction'] = Matcher_Parser_227()
rules['Parser.actionExpr'] = Matcher_Parser_257()
rules['Parser.hostExpr'] = Matcher_Parser_305()
rules['Parser.hostListItem'] = Matcher_Parser_316()
rules['Parser.var'] = Matcher_Parser_329()
rules['Parser.string'] = Matcher_Parser_346()
rules['Parser.char'] = Matcher_Parser_359()
rules['Parser.innerChar'] = Matcher_Parser_368()
rules['Parser.escape'] = Matcher_Parser_389()
rules['Parser.name'] = Matcher_Parser_399()
rules['Parser.nameStart'] = Matcher_Parser_406()
rules['Parser.nameChar'] = Matcher_Parser_416()
rules['Parser.space'] = Matcher_Parser_429()
...
class Matcher_CodeGenerator_44:
    def run(self, stream):
        return stream.bind('m', Matcher_CodeGenerator_43().run(stream))
class Matcher_CodeGenerator_45:
    def run(self, stream):
        return rules['CodeGenerator.astList'].run(stream)
class Matcher_CodeGenerator_46:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_45().run(stream))
...
class Matcher_CodeGenerator_48:
    def run(self, stream):
        return stream.match_list(Matcher_CodeGenerator_47())
