...
class Matcher_Parser_101:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_100())
class Matcher_Parser_102:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_101().run(stream))
...
class Matcher_Parser_108:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_107())
...
class Matcher_Parser_111:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_110())
...
class Matcher_Parser_114:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_113().run(stream))
...
class Matcher_Parser_120:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_119())
class Matcher_Parser_121:
    def run(self, stream):
        return rules['Parser.expr2'].run(stream)
class Matcher_Parser_122:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_121().run(stream))
...
class Matcher_Parser_142:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_141())
...
class Matcher_Parser_145:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_144())
...
class Matcher_Parser_148:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_147().run(stream))
...
class Matcher_Parser_155:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_154())
...
class Matcher_Parser_161:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_160().run(stream))
...
class Matcher_Parser_165:
    def run(self, stream):
        return stream.bind('y', Matcher_Parser_164().run(stream))
...
class Matcher_Parser_174:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_173())
...
class Matcher_Parser_177:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_176())
...
class Matcher_Parser_179:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_178())
class Matcher_Parser_180:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_179().run(stream))
...
class Matcher_Parser_207:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_206())
class Matcher_Parser_208:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_207().run(stream))
...
class Matcher_Parser_229:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_228())
...
class Matcher_Parser_242:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_241())
...
class Matcher_Parser_247:
    def run(self, stream):
        return stream.bind('y', Matcher_Parser_246().run(stream))
class Matcher_Parser_248:
    def run(self, stream):
        return rules['Parser.actionExpr'].run(stream)
class Matcher_Parser_249:
    def run(self, stream):
        return stream.bind('z', Matcher_Parser_248().run(stream))
...
class Matcher_Parser_252:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_251())
...
class Matcher_Parser_259:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_258())
...
class Matcher_Parser_263:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_262().run(stream))
...
class Matcher_Parser_272:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_271().run(stream))
...
class Matcher_Parser_284:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_283().run(stream))
...
class Matcher_Parser_313:
    def run(self, stream):
        return stream.bind('ys', Matcher_Parser_312().run(stream))
...
class Matcher_Parser_321:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_320().run(stream))
...
class Matcher_Parser_343:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_342().run(stream))
...
class Matcher_Parser_356:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_355().run(stream))
...
class Matcher_Parser_397:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_396())
class Matcher_Parser_398:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_397().run(stream))
...
class Matcher_Parser_429:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_428())
...
rules['Parser.expr'] = Matcher_Parser_112()
rules['Parser.expr1'] = Matcher_Parser_146()
rules['Parser.expr2'] = Matcher_Parser_215()
rules['Parser.matchChar'] = Matcher_Parser_221()
rules['Parser.maybeAction'] = Matcher_Parser_230()
rules['Parser.actionExpr'] = Matcher_Parser_260()
...
rules['Parser.name'] = Matcher_Parser_402()
rules['Parser.nameStart'] = Matcher_Parser_409()
rules['Parser.nameChar'] = Matcher_Parser_419()
rules['Parser.space'] = Matcher_Parser_432()
...
class Matcher_CodeGenerator_57:
    def run(self, stream):
        return stream.match_list(Matcher_CodeGenerator_56())
...
class Matcher_CodeGenerator_60:
    def run(self, stream):
        return stream.with_scope(Matcher_CodeGenerator_59())
...
class Matcher_CodeGenerator_209:
    def run(self, stream):
        return stream.operator_star(Matcher_CodeGenerator_208())
class Matcher_CodeGenerator_210:
    def run(self, stream):
        return stream.bind('xs', Matcher_CodeGenerator_209().run(stream))
...
class Matcher_CodeGenerator_220:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_219().run(stream))
...
rules['CodeGenerator.Scope'] = Matcher_CodeGenerator_61()
...
rules['CodeGenerator.astList'] = Matcher_CodeGenerator_214()
rules['CodeGenerator.matcher'] = Matcher_CodeGenerator_218()
rules['CodeGenerator.repr'] = Matcher_CodeGenerator_224()
