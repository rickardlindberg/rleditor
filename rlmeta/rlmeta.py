...
class Matcher_Parser_254:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_253())
class Matcher_Parser_255:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_254().run(stream))
...
class Matcher_Parser_264:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_263())
class Matcher_Parser_265:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_264().run(stream))
class Matcher_Parser_266:
    def run(self, stream):
        return rules['Parser.innerChar'].run(stream)
class Matcher_Parser_267:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_266().run(stream))
...
class Matcher_Parser_285:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_284())
class Matcher_Parser_286:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_285().run(stream))
...
class Matcher_Parser_292:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_291().run(stream))
...
class Matcher_Parser_303:
    def run(self, stream):
        return stream.bind('y', Matcher_Parser_302().run(stream))
class Matcher_Parser_304:
    def run(self, stream):
        return rules['Parser.actionExpr'].run(stream)
class Matcher_Parser_305:
    def run(self, stream):
        return stream.bind('z', Matcher_Parser_304().run(stream))
...
class Matcher_Parser_308:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_307())
...
class Matcher_Parser_310:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_309())
class Matcher_Parser_311:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_310().run(stream))
...
class Matcher_Parser_324:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_323().run(stream))
...
class Matcher_Parser_332:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_331())
class Matcher_Parser_333:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_332().run(stream))
...
class Matcher_Parser_339:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_338())
...
class Matcher_Parser_344:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_343())
class Matcher_Parser_345:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_344().run(stream))
...
class Matcher_Parser_351:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_350())
...
class Matcher_Parser_359:
    def run(self, stream):
        return stream.bind('ys', Matcher_Parser_358().run(stream))
...
class Matcher_Parser_373:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_372())
class Matcher_Parser_374:
    def run(self, stream):
        return stream.bind('ys', Matcher_Parser_373().run(stream))
class Matcher_Parser_375:
    def run(self, stream):
        return rules['Parser.hostExpr'].run(stream)
class Matcher_Parser_376:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_375().run(stream))
...
class Matcher_Parser_379:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_378())
...
class Matcher_Parser_382:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_381().run(stream))
...
class Matcher_Parser_389:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_388())
...
class Matcher_Parser_398:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_397())
...
class Matcher_Parser_401:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_400())
...
class Matcher_Parser_404:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_403().run(stream))
...
class Matcher_Parser_415:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_414())
class Matcher_Parser_416:
    def run(self, stream):
        return rules['Parser.innerChar'].run(stream)
class Matcher_Parser_417:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_416().run(stream))
...
class Matcher_Parser_437:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_436())
...
class Matcher_Parser_456:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_455().run(stream))
class Matcher_Parser_457:
    def run(self, stream):
        return rules['Parser.nameChar'].run(stream)
class Matcher_Parser_458:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_457())
class Matcher_Parser_459:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_458().run(stream))
...
class Matcher_Parser_466:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_465())
...
class Matcher_Parser_473:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_472())
...
class Matcher_Parser_490:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_489())
...
rules['Parser.hostExpr'] = Matcher_Parser_369()
rules['Parser.hostListItem'] = Matcher_Parser_380()
rules['Parser.var'] = Matcher_Parser_393()
rules['Parser.string'] = Matcher_Parser_410()
rules['Parser.char'] = Matcher_Parser_423()
rules['Parser.innerChar'] = Matcher_Parser_432()
rules['Parser.escape'] = Matcher_Parser_453()
rules['Parser.name'] = Matcher_Parser_463()
rules['Parser.nameStart'] = Matcher_Parser_470()
rules['Parser.nameChar'] = Matcher_Parser_480()
rules['Parser.space'] = Matcher_Parser_493()
...
class Matcher_CodeGenerator_132:
    def run(self, stream):
        return stream.bind('m', Matcher_CodeGenerator_131().run(stream))
class Matcher_CodeGenerator_133:
    def run(self, stream):
        return rules['CodeGenerator.ast'].run(stream)
class Matcher_CodeGenerator_134:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_133().run(stream))
...
class Matcher_CodeGenerator_141:
    def run(self, stream):
        return stream.bind('m', Matcher_CodeGenerator_140().run(stream))
...
class Matcher_CodeGenerator_156:
    def run(self, stream):
        return stream.with_scope(Matcher_CodeGenerator_155())
...
class Matcher_CodeGenerator_159:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_158().run(stream))
class Matcher_CodeGenerator_160:
    def run(self, stream):
        return rules['CodeGenerator.repr'].run(stream)
class Matcher_CodeGenerator_161:
    def run(self, stream):
        return stream.bind('y', Matcher_CodeGenerator_160().run(stream))
...
class Matcher_CodeGenerator_169:
    def run(self, stream):
        return stream.bind('y', Matcher_CodeGenerator_168().run(stream))
class Matcher_CodeGenerator_170:
    def run(self, stream):
        return rules['CodeGenerator.ast'].run(stream)
class Matcher_CodeGenerator_171:
    def run(self, stream):
        return stream.bind('z', Matcher_CodeGenerator_170().run(stream))
...
class Matcher_CodeGenerator_203:
    def run(self, stream):
        return stream.bind('y', Matcher_CodeGenerator_202().run(stream))
...
class Matcher_CodeGenerator_206:
    def run(self, stream):
        return stream.with_scope(Matcher_CodeGenerator_205())
...
class Matcher_CodeGenerator_209:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_208().run(stream))
...
class Matcher_CodeGenerator_224:
    def run(self, stream):
        return stream.operator_star(Matcher_CodeGenerator_223())
class Matcher_CodeGenerator_225:
    def run(self, stream):
        return stream.bind('xs', Matcher_CodeGenerator_224().run(stream))
...
class Matcher_CodeGenerator_235:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_234().run(stream))
...
rules['CodeGenerator.MatchRange'] = Matcher_CodeGenerator_138()
rules['CodeGenerator.Action'] = Matcher_CodeGenerator_147()
rules['CodeGenerator.Any'] = Matcher_CodeGenerator_151()
rules['CodeGenerator.Eq'] = Matcher_CodeGenerator_157()
rules['CodeGenerator.Range'] = Matcher_CodeGenerator_165()
rules['CodeGenerator.Set'] = Matcher_CodeGenerator_175()
rules['CodeGenerator.String'] = Matcher_CodeGenerator_179()
rules['CodeGenerator.List'] = Matcher_CodeGenerator_185()
rules['CodeGenerator.ListItem'] = Matcher_CodeGenerator_193()
rules['CodeGenerator.Format'] = Matcher_CodeGenerator_199()
rules['CodeGenerator.Call'] = Matcher_CodeGenerator_207()
rules['CodeGenerator.Lookup'] = Matcher_CodeGenerator_213()
rules['CodeGenerator.Paren'] = Matcher_CodeGenerator_218()
rules['CodeGenerator.Placeholder'] = Matcher_CodeGenerator_222()
rules['CodeGenerator.astList'] = Matcher_CodeGenerator_229()
rules['CodeGenerator.matcher'] = Matcher_CodeGenerator_233()
rules['CodeGenerator.repr'] = Matcher_CodeGenerator_239()
