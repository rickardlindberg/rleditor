...
class Matcher_Parser_69:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_68())
class Matcher_Parser_70:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_69().run(stream))
...
class Matcher_Parser_73:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_72())
...
class Matcher_Parser_76:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_75())
class Matcher_Parser_77:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_76().run(stream))
class Matcher_Parser_78:
    def run(self, stream):
        return rules['Parser.maybeAction'].run(stream)
class Matcher_Parser_79:
    def run(self, stream):
        return stream.bind('ys', Matcher_Parser_78().run(stream))
...
class Matcher_Parser_81:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_80())
class Matcher_Parser_82:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_81().run(stream))
...
class Matcher_Parser_85:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_84())
...
class Matcher_Parser_99:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_98())
...
class Matcher_Parser_104:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_103())
class Matcher_Parser_105:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_104().run(stream))
...
class Matcher_Parser_107:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_106())
class Matcher_Parser_108:
    def run(self, stream):
        return stream.bind('r2', Matcher_Parser_107().run(stream))
...
class Matcher_Parser_113:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_112())
class Matcher_Parser_114:
    def run(self, stream):
        return stream.bind('r1', Matcher_Parser_113().run(stream))
...
class Matcher_Parser_117:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_116())
...
class Matcher_Parser_119:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_118())
class Matcher_Parser_120:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_119().run(stream))
...
class Matcher_Parser_123:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_122())
...
class Matcher_Parser_126:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_125())
class Matcher_Parser_127:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_126().run(stream))
class Matcher_Parser_128:
    def run(self, stream):
        return rules['Parser.expr2'].run(stream)
class Matcher_Parser_129:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_128().run(stream))
...
class Matcher_Parser_135:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_134())
...
class Matcher_Parser_137:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_136())
class Matcher_Parser_138:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_137().run(stream))
class Matcher_Parser_139:
    def run(self, stream):
        return rules['Parser.expr2'].run(stream)
class Matcher_Parser_140:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_139().run(stream))
...
class Matcher_Parser_146:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_145())
...
class Matcher_Parser_148:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_147())
class Matcher_Parser_149:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_148().run(stream))
...
class Matcher_Parser_154:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_153().run(stream))
...
class Matcher_Parser_157:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_156())
...
class Matcher_Parser_162:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_161())
class Matcher_Parser_163:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_162().run(stream))
...
class Matcher_Parser_166:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_165())
...
class Matcher_Parser_168:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_167())
class Matcher_Parser_169:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_168().run(stream))
class Matcher_Parser_170:
    def run(self, stream):
        return rules['Parser.expr2'].run(stream)
class Matcher_Parser_171:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_170().run(stream))
...
class Matcher_Parser_174:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_173())
...
class Matcher_Parser_177:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_176())
class Matcher_Parser_178:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_177().run(stream))
class Matcher_Parser_179:
    def run(self, stream):
        return rules['Parser.name'].run(stream)
class Matcher_Parser_180:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_179().run(stream))
...
class Matcher_Parser_187:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_186())
...
class Matcher_Parser_190:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_189())
...
class Matcher_Parser_192:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_191())
class Matcher_Parser_193:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_192().run(stream))
...
class Matcher_Parser_200:
    def run(self, stream):
        return stream.bind('y', Matcher_Parser_199().run(stream))
...
class Matcher_Parser_205:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_204())
class Matcher_Parser_206:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_205().run(stream))
...
class Matcher_Parser_212:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_211())
...
class Matcher_Parser_217:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_216())
class Matcher_Parser_218:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_217().run(stream))
...
class Matcher_Parser_225:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_224())
class Matcher_Parser_226:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_225().run(stream))
...
class Matcher_Parser_234:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_233())
class Matcher_Parser_235:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_234().run(stream))
...
class Matcher_Parser_240:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_239().run(stream))
...
class Matcher_Parser_248:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_247())
class Matcher_Parser_249:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_248().run(stream))
...
class Matcher_Parser_254:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_253().run(stream))
...
class Matcher_Parser_257:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_256())
...
class Matcher_Parser_259:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_258())
class Matcher_Parser_260:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_259().run(stream))
...
class Matcher_Parser_269:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_268())
class Matcher_Parser_270:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_269().run(stream))
class Matcher_Parser_271:
    def run(self, stream):
        return rules['Parser.innerChar'].run(stream)
class Matcher_Parser_272:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_271().run(stream))
...
class Matcher_Parser_275:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_274())
...
class Matcher_Parser_278:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_277().run(stream))
...
class Matcher_Parser_280:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_279())
class Matcher_Parser_281:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_280().run(stream))
...
class Matcher_Parser_287:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_286())
...
class Matcher_Parser_290:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_289())
class Matcher_Parser_291:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_290().run(stream))
...
class Matcher_Parser_297:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_296().run(stream))
...
class Matcher_Parser_303:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_302())
...
class Matcher_Parser_306:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_305())
...
class Matcher_Parser_308:
    def run(self, stream):
        return stream.bind('y', Matcher_Parser_307().run(stream))
class Matcher_Parser_309:
    def run(self, stream):
        return rules['Parser.actionExpr'].run(stream)
class Matcher_Parser_310:
    def run(self, stream):
        return stream.bind('z', Matcher_Parser_309().run(stream))
...
class Matcher_Parser_315:
    def run(self, stream):
        return stream.match_range(Matcher_Parser_314())
class Matcher_Parser_316:
    def run(self, stream):
        return stream.bind('r', Matcher_Parser_315().run(stream))
...
class Matcher_Parser_322:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_321().run(stream))
...
class Matcher_Parser_337:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_336())
class Matcher_Parser_338:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_337().run(stream))
...
class Matcher_Parser_344:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_343())
...
class Matcher_Parser_349:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_348())
class Matcher_Parser_350:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_349().run(stream))
...
class Matcher_Parser_358:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_357().run(stream))
...
class Matcher_Parser_363:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_362())
class Matcher_Parser_364:
    def run(self, stream):
        return stream.bind('ys', Matcher_Parser_363().run(stream))
...
class Matcher_Parser_378:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_377())
class Matcher_Parser_379:
    def run(self, stream):
        return stream.bind('ys', Matcher_Parser_378().run(stream))
class Matcher_Parser_380:
    def run(self, stream):
        return rules['Parser.hostExpr'].run(stream)
class Matcher_Parser_381:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_380().run(stream))
...
class Matcher_Parser_384:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_383())
...
class Matcher_Parser_392:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_391())
...
class Matcher_Parser_394:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_393())
...
class Matcher_Parser_397:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_396())
...
class Matcher_Parser_403:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_402())
...
class Matcher_Parser_408:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_407())
class Matcher_Parser_409:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_408().run(stream))
...
class Matcher_Parser_420:
    def run(self, stream):
        return stream.operator_not(Matcher_Parser_419())
class Matcher_Parser_421:
    def run(self, stream):
        return rules['Parser.innerChar'].run(stream)
class Matcher_Parser_422:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_421().run(stream))
...
class Matcher_Parser_433:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_432())
...
class Matcher_Parser_442:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_441())
...
class Matcher_Parser_457:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_456())
...
class Matcher_Parser_461:
    def run(self, stream):
        return stream.bind('x', Matcher_Parser_460().run(stream))
class Matcher_Parser_462:
    def run(self, stream):
        return rules['Parser.nameChar'].run(stream)
class Matcher_Parser_463:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_462())
class Matcher_Parser_464:
    def run(self, stream):
        return stream.bind('xs', Matcher_Parser_463().run(stream))
...
class Matcher_Parser_471:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_470())
...
class Matcher_Parser_478:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_477())
...
class Matcher_Parser_481:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_480())
...
class Matcher_Parser_484:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_483())
...
class Matcher_Parser_489:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_488())
...
class Matcher_Parser_493:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_492())
...
class Matcher_Parser_495:
    def run(self, stream):
        return stream.operator_star(Matcher_Parser_494())
...
class Matcher_Parser_497:
    def run(self, stream):
        return stream.with_scope(Matcher_Parser_496())
...
rules['Parser.choice'] = Matcher_Parser_74()
rules['Parser.sequence'] = Matcher_Parser_86()
rules['Parser.expr'] = Matcher_Parser_124()
rules['Parser.expr1'] = Matcher_Parser_175()
rules['Parser.expr2'] = Matcher_Parser_267()
rules['Parser.matchChar'] = Matcher_Parser_276()
rules['Parser.maybeAction'] = Matcher_Parser_288()
rules['Parser.actionExpr'] = Matcher_Parser_326()
rules['Parser.hostExpr'] = Matcher_Parser_374()
rules['Parser.hostListItem'] = Matcher_Parser_385()
rules['Parser.var'] = Matcher_Parser_398()
rules['Parser.string'] = Matcher_Parser_415()
rules['Parser.char'] = Matcher_Parser_428()
rules['Parser.innerChar'] = Matcher_Parser_437()
rules['Parser.escape'] = Matcher_Parser_458()
rules['Parser.name'] = Matcher_Parser_468()
rules['Parser.nameStart'] = Matcher_Parser_475()
rules['Parser.nameChar'] = Matcher_Parser_485()
rules['Parser.space'] = Matcher_Parser_498()
...
class Matcher_CodeGenerator_123:
    def run(self, stream):
        return stream.bind('m', Matcher_CodeGenerator_122().run(stream))
class Matcher_CodeGenerator_124:
    def run(self, stream):
        return rules['CodeGenerator.ast'].run(stream)
class Matcher_CodeGenerator_125:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_124().run(stream))
...
class Matcher_CodeGenerator_128:
    def run(self, stream):
        return stream.with_scope(Matcher_CodeGenerator_127())
...
class Matcher_CodeGenerator_131:
    def run(self, stream):
        return stream.bind('m', Matcher_CodeGenerator_130().run(stream))
class Matcher_CodeGenerator_132:
    def run(self, stream):
        return rules['CodeGenerator.ast'].run(stream)
class Matcher_CodeGenerator_133:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_132().run(stream))
...
class Matcher_CodeGenerator_136:
    def run(self, stream):
        return stream.with_scope(Matcher_CodeGenerator_135())
...
class Matcher_CodeGenerator_140:
    def run(self, stream):
        return stream.bind('m', Matcher_CodeGenerator_139().run(stream))
class Matcher_CodeGenerator_141:
    def run(self, stream):
        return rules['CodeGenerator.ast'].run(stream)
class Matcher_CodeGenerator_142:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_141().run(stream))
...
class Matcher_CodeGenerator_145:
    def run(self, stream):
        return stream.with_scope(Matcher_CodeGenerator_144())
...
class Matcher_CodeGenerator_155:
    def run(self, stream):
        return stream.with_scope(Matcher_CodeGenerator_154())
...
class Matcher_CodeGenerator_158:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_157().run(stream))
class Matcher_CodeGenerator_159:
    def run(self, stream):
        return rules['CodeGenerator.repr'].run(stream)
class Matcher_CodeGenerator_160:
    def run(self, stream):
        return stream.bind('y', Matcher_CodeGenerator_159().run(stream))
...
class Matcher_CodeGenerator_166:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_165().run(stream))
class Matcher_CodeGenerator_167:
    def run(self, stream):
        return rules['CodeGenerator.ast'].run(stream)
class Matcher_CodeGenerator_168:
    def run(self, stream):
        return stream.bind('y', Matcher_CodeGenerator_167().run(stream))
class Matcher_CodeGenerator_169:
    def run(self, stream):
        return rules['CodeGenerator.ast'].run(stream)
class Matcher_CodeGenerator_170:
    def run(self, stream):
        return stream.bind('z', Matcher_CodeGenerator_169().run(stream))
...
class Matcher_CodeGenerator_183:
    def run(self, stream):
        return stream.with_scope(Matcher_CodeGenerator_182())
...
class Matcher_CodeGenerator_188:
    def run(self, stream):
        return stream.bind('y', Matcher_CodeGenerator_187().run(stream))
...
class Matcher_CodeGenerator_202:
    def run(self, stream):
        return stream.bind('y', Matcher_CodeGenerator_201().run(stream))
...
class Matcher_CodeGenerator_223:
    def run(self, stream):
        return stream.operator_star(Matcher_CodeGenerator_222())
class Matcher_CodeGenerator_224:
    def run(self, stream):
        return stream.bind('xs', Matcher_CodeGenerator_223().run(stream))
...
class Matcher_CodeGenerator_234:
    def run(self, stream):
        return stream.bind('x', Matcher_CodeGenerator_233().run(stream))
...
rules['CodeGenerator.MatchObject'] = Matcher_CodeGenerator_120()
rules['CodeGenerator.MatchList'] = Matcher_CodeGenerator_129()
rules['CodeGenerator.MatchRange'] = Matcher_CodeGenerator_137()
rules['CodeGenerator.Action'] = Matcher_CodeGenerator_146()
rules['CodeGenerator.Any'] = Matcher_CodeGenerator_150()
rules['CodeGenerator.Eq'] = Matcher_CodeGenerator_156()
rules['CodeGenerator.Range'] = Matcher_CodeGenerator_164()
rules['CodeGenerator.Set'] = Matcher_CodeGenerator_174()
rules['CodeGenerator.String'] = Matcher_CodeGenerator_178()
rules['CodeGenerator.List'] = Matcher_CodeGenerator_184()
rules['CodeGenerator.ListItem'] = Matcher_CodeGenerator_192()
rules['CodeGenerator.Format'] = Matcher_CodeGenerator_198()
rules['CodeGenerator.Call'] = Matcher_CodeGenerator_206()
rules['CodeGenerator.Lookup'] = Matcher_CodeGenerator_212()
rules['CodeGenerator.Paren'] = Matcher_CodeGenerator_217()
rules['CodeGenerator.Placeholder'] = Matcher_CodeGenerator_221()
rules['CodeGenerator.astList'] = Matcher_CodeGenerator_228()
rules['CodeGenerator.matcher'] = Matcher_CodeGenerator_232()
rules['CodeGenerator.repr'] = Matcher_CodeGenerator_238()
